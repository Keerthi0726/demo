...
<%String instemail=(String)request.getParameter("Inst");%>
...
Connection con = DriverManager.getConnection(url,uname,upass);
	...
	ResultSet rs51=st51.executeQuery("select * from hostademo where Uid='"+instemail+"'");
    ...
    { 
     %>      
				...
				<div class="col-md-3  "><div class="demos">
					...
					<h4 class="designation1"><b><%=rs51.getString(2)%></b></h4>
					 <h4 class="designation2"><b><%=rs51.getString(3)%></b></h4>
					<h5 class="designation"><i class="fa fa-calendar"></i><b><%=rs51.getString(6) %></b> ||<i class="fa fa-clock-o"></i> <b><%=rs51.getString(7)%></b></h5>
					
					<p><b><%=rs51.getString(13)%></b></p>
					...
					<h4>
						<a class="label label-view" href="Viewandbook.jsp?DemoId=<%=rs51.getString(1)%>">View & Book</a>
						</h4></div>

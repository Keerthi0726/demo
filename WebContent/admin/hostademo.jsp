         ...
         <td>
          <div class="form-group">
            ...
            <%Connection con6 = (Connection)DriverManager.getConnection(url,uname,upass);
           	 ...
           	 ResultSet rs6=st6.executeQuery("select * from newregistration");
           	 %><select class="form-control" name="institutename" onchange="showState(this.value)" id="location3">
           	 <option >--Please Select--</option>
           	 <%
           	while(rs6.next()){
           		%><option ><%=rs6.getString(4)%></option>
...
con6.close(); 
          ...
          <div class="form-group" >
            ...
            <%Connection con7 = (Connection)DriverManager.getConnection(url,uname,upass);
           	 ...
           	 ResultSet rs7=st7.executeQuery("select * from trainerslist");

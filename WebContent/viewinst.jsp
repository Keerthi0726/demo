...
<%@ include file="dbcon.jsp"%>
        ...
        <%  Connection con = DriverManager.getConnection(url,uname,upass);
									 ...
									 Statement st6= con.createStatement();				
										...
										ResultSet rs6=st6.executeQuery("select * from newregistration where EmailId='"+demo_id+"'");
										if(rs6.next()){%>
				...
				<div class="col-md-7 w3l_contact_form">
					...
					<h4 ><b><u><%= rs6.getString("InstitutenameorTrainername")%></u></b></h4>
						<p style="color:white; font-size: 150%"> Address:</p>
							<p style="color:white; font-size: 150%"><b><%= rs6.getString("MainBranchAddress")%></b></p>
						<%}
					 %>
				</div>
				<div class=" agileits_w3layouts_contact_gridl">
					<h4 ><b><u>Dealing Technologies</u></b></h4><ul>
					<%
					 Statement st5= con.createStatement();
						
						
						
						ResultSet rs5=st5.executeQuery("select * from listoftechnologies where uid='"+demo_id+"'");
						while(rs5.next()){%>
						
							<li style="color:white; font-size: 120%"><b><%= rs5.getString("TechnologyName")%></b></li>
						<%}
					 %>
					...
					<table class="table"  width="100%" border="1">
					 <caption><br><h4 ><b><u>Demos</u></b></h4></caption>
					 <tr>
       <th><a class="active" style="color:#e5f512;">Demo Name:</a></th>
...
Statement st67= con.createStatement();
		...
		ResultSet rs67=st67.executeQuery("select * from hostademo where uid='"+demo_id+"'");
		if(rs67.next()){
        do{%>

...
Connection con = DriverManager.getConnection(url,uname,upass);
	...
	ResultSet rss52=st52.executeQuery("select * from hostademo where date=curdate()");

if(rss52.next()==true){
	
	
	
	ResultSet rs52=st52.executeQuery("select * from hostademo where date=curdate()");
    ...
    while(rs52.next()) 
    {
     %>
				...
				<div class="col-md-3  "><div class="demos">
					...
					<h4 class="designation1"><b><%=rs52.getString(2)%></b></h4>
					 <h4 class="designation2"><b><%=rs52.getString(3)%></b></h4>
					<h5 class="designation"><i class="fa fa-calendar"></i><b><%=rs52.getString(6) %></b> ||<i class="fa fa-clock-o"></i> <b><%=rs52.getString(7)%></b></h5>
					
					<p><b><%=rs52.getString(13)%></b></p>
					...
					<h4>
						<a class="label label-view" href="Viewandbook.jsp?DemoId=<%=rs52.getString(1)%>">View & Book</a>
						</h4></div>
				...
				<% }  rs52.close();}else{%><h4>--No Demos to Display--<h4><%}%>

...
<%@ include file="dbcon.jsp"%>
		...
		ResultSet rs67=st67.executeQuery("select * from hostademo where DemoId='"+demo_id+"'");
		if(rs67.next()){
		String string=rs67.getString(14);%>
				...
				<h4><b><u>Booking Form</u></b></h4> 
					<form action="inst_userbookingcode.jsp?DemoId=<%=rs67.getString(1)%> " method="post">
				...
				<div class="col-md-5 agileits_w3layouts_contact_gridl">
					...
					<table class="table"  width="100%" border="1">
						...
						<tbody>
							...
							<%-- <tr>
								<td ><a class="active" style="color:#e5f512;">Demo Id:</a></td>
								<td><span style="color:white;"><%=rs67.getString(1)%></span></td>
							</tr> --%>
							<tr>
								<td><a class="active" style="color:#e5f512;">Demo Name:</a></td>
								<td><span style="color:white;"><%=rs67.getString(2)%></span></td>
							</tr>
							<tr>
								<td><a class="active" style="color:#e5f512;">Institute Name:</a></td>
								<td><span style="color:white;"><%=rs67.getString(3)%></span></td>
							</tr>
							<tr>
								<td><a class="active" style="color:#e5f512;">Date & Time :</a></td>
								<td><span style="color:white;"><%=rs67.getString(6)%>&emsp;||&emsp;<%=rs67.getString(7)%></span></td>
							</tr>
							
							<tr>
								<td><a class="active" style="color:#e5f512;">Duration:</a></td>
							...
							<tr>
								<td><a class="active" style="color:#e5f512;">No of Seats:</a></td>
								<td><span style="color:white;"><%=rs67.getString(12)%></span></td>
							</tr>
							<tr>
								<td><a class="active"  style="color:#e5f512;">Trainer Name:</a></td>
								<td><span style="color:white;"><%=rs67.getString(4)%></span></td>
							</tr>
							<tr>
								<td><a class="active" style="color:#e5f512;">TrainerExperience:</a></td>
								<%if(rs67.getString(5)==String.valueOf(1))
								{%>
									
								<td><span style="color:white;"><%=rs67.getString(5)%>&emsp;Year</span></td>
					
								<%} else{%>
								<td><span style="color:white;"><%=rs67.getString(5)%>&emsp;Years</span></td>
							...
							<tr>
								<td><a class="active" style="color:#e5f512;">Address:</a></td>

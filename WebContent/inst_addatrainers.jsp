...
<%@ include file="dbcon.jsp"%>
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Icon Cards-->
      <div class="card-body">
       <form name="f1" action="inst_addatrainersucc.jsp" method="POST" onsubmit="return check();">
  ...
  <td>
       <div class="form-group">
            ...
            <%   
           	 ...
           	 ResultSet rs3=st3.executeQuery("select * from newregistration where EmailId='"+uid+"'");
           	
           	if(rs3.next()){
           		%><input class="form-control" name="institutename"  type="text" value="<%=rs3.getString(4)%>" readonly>
...
con2.close();%>
  ...
  <td>      <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input class="form-control" name="trainercontact"  type="text" ></div></td>

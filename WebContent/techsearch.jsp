	...
	<div class="w3-guides" id="guide">
		<div class="container">
			<div class="w3ls-title">
				<h2 class="agileits-title">Demo Schedules</h2> 
			</div>
			<div class="guide-grids">
			<%@ page import ="java.sql.*" %>
<%@ page import ="javax.sql.*" %>
<%@ include file="dbcon.jsp"%>
<%String techname=(String)request.getParameter("techname");%>
...
Connection con = DriverManager.getConnection(url,uname,upass);
	...
	ResultSet rs62=st62.executeQuery("select * from hostademo where demoname='"+techname+"'");
    ...
    { 
     %>      
				...
				<div class="col-md-3  ">
					...
					<h4 class="designation1"><b><%=rs62.getString(2)%></b></h4>
					 <h4 class="designation2"><b><%=rs62.getString(3)%></b></h4>
					<h5 class="designation"><i class="fa fa-calendar"></i><b><%=rs62.getString(6) %></b> ||<i class="fa fa-clock-o"></i> <b><%=rs62.getString(7)%></b></h5>
					
					<p><b><%=rs62.getString(13)%></b></p>
					...
					<h4>
						<a class="label label-view" href="Viewandbook.jsp?DemoId=<%=rs62.getString(1)%>">View & Book</a>
						</h4></div>

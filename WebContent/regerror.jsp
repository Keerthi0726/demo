...
<body> 
	...
	<div class="contact">
		<div class="container"> 
		<div class="alert"style="background-color:#f00 ">
  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
  <strong>Error !</strong> Credentials already Exists...
   </div>
			<div class="contact_wthreerow agileits-w3layouts">
				<div class="col-md-7 w3l_contact_form">
					<h4>Registration Form</h4> 
					<form name="form" action="inst_newregister.jsp" method="post" onsubmit="javascript:return validate();">
					<table>
					<tr>
					    <td>
						Type Of Trainer:<select type="text" class="form-control" name="typeofinstitute">
            <option type="text" value="">--Please Select--</option>
            <option type="text" value="Institute">Institute</option>
            <option type="text" value="Individual">Individual</option></select>
					    </td>
					    <td>
						Institute Owner Name:<input type="text" name="instituteownername" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required="">
					    </td>
					...
					<tr>
					    ...
					    <td>
						Institute Name:<input type="text" name="institutetrainername"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required="">
					    </td>
					    <td>
						Institute Email:<input type="email" name="emailid" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required="">
					    </td>
					</tr>
					 <tr>
					    <td>
						Password:<input type="password" name="password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required="">
					    </td>
					     <td>
						Confirm Password:<input type="password" name="confirmpassword" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required="">
					    </td>
					    
					</tr>
					<tr>
					     <td>
						Institute Contact No:<input type="numeric" name="phone"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required="">
					    </td>
					   
					    <td>
						Address:<input type="text" name="mainbranchaddress"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required="">
					    </td>
					    
					</tr>
					<tr>
					    <td>
						Area:<input type="text" name="area"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required="">
					    </td>
					    <td>
						City:<input type="text" name="city"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required="">
					    </td>
					...
					<tr>
					     <td>
						State:<input type="text" name="state" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required="">
					    </td>
					   <td>
			...
			<div class="footer-btm-agileinfo">
				...
				<div class="col-md-4 col-xs-5 footer-grid footer-review">
					...
					<div class="copy-w3lsright"> 
						<p>� 2017 Demo2Day. All rights reserved | Design by <a href="www.vbrsit.com">Vbrsit Solution Pvt. Ltd</a></p>
					</div> 
				</div> 
				<div class="clearfix"> </div>
			</div>   

...
<body> 
<div id="demo-1" data-zs-src='["images1/b1.jpg", "images1/b2.jpg", "images1/b3.jpg","images1/b4.jpg"]' data-zs-overlay="dots">
...
<%@ include file="dbcon.jsp"%>
		...
		ResultSet rs67=st67.executeQuery("select * from hostademo where demoname='"+demo_id+"'");
		if(rs67.next()){
		String string=rs67.getString(14);%>
				...
				<h4><b><u><%=rs67.getString(2) %></u></b></h4> 
					<%Statement st68= con.createStatement();
					 ResultSet rs68=st68.executeQuery("select * from listoftechnologies where technologyname='"+demo_id+"'");
					if(rs68.next()){%>
					<p style="color:white; font-size: 100%"><b><%=rs68.getString(4)%></b></p>
					<%} %>

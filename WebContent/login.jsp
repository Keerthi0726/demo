	...
	<!--/banner-info-->
	   <div class="header">
			   <div class="header-main">
				...
				<nav class="navbar navbar-default">
						<div class="navbar-header">
							...
							<h1><a  href="index.jsp">Demo<span>Search for Demo</span></a></h1>
						</div>
						<!-- navbar-header -->
		...
		<div class="container"> 
				...
				<h4><b><u>Login</u></b></h4> 
					<form action="inst_login.jsp" method="post">
					
						<h4 style="color: #000;">Email:</h4>	<input type="email" name="email" placeholder="Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" required="">
					<br>
					<br>
					
					<h4 style="color: #000;">Password:</h4><input type="password" name="pass" placeholder="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}" required="">
